...
/*
   NOTE:  THIS FILE HAS BEEN SLIGHTLY MODIFIED FOR SOCKHOP.
          Please be aware that is not quite the same as the "official" regex.cpp
          if you choose to redistribute it!  --Jeremy
*/
...
/* We need this for `shRegex.h', and perhaps for the Emacs include files.  */
#include <sys/types.h>
#include <string.h>
...
/* These are the command codes that appear in compiled regular
   ...
   So shRegex.h defines a symbol `RE_EXACTN_VALUE' to be 1; the value of
...
/* Specify the precise syntax of regexps for compilation.  This provides
   ...
   defined in shRegex.h.  We return the old syntax.  */
#ifdef JAF_CRAP
reg_syntax_t
...
/* This table gives an error message for each of the error codes listed
   in shRegex.h.  Obviously the order here has to be same as there.  */
...
/* `regex_compile' compiles PATTERN (of length SIZE) according to SYNTAX.
   Returns one of error codes defined in `shRegex.h', or zero for success.
...
/* regcomp takes a regular expression as a string and compiles it.
   ...
   It returns 0 if it succeeds, nonzero if it doesn't.  (See shRegex.h for

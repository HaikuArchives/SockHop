...
#ifndef _EllipseDrawingWORKER_H_
#define _EllipseDrawingWORKER_H_
...
#ifdef __INTEL__
_EXPORT class EllipseDrawingWorker;
#else
#pragma export on
#endif

class EllipseDrawingWorker : public SHWorker
{
public:

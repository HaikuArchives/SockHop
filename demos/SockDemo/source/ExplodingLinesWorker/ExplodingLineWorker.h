...
#ifndef _ExplodingLineWORKER_H_
#define _ExplodingLineWORKER_H_
...
#ifdef __INTEL__
_EXPORT class ExplodingLineWorker;
#else
#pragma export on
#endif

class ExplodingLineWorker : public SHWorker
{
public:
